...
def main():
    ...
    VALIDATION_PER = 0.1 # Validation Percentage (you can play with this parameter)
    ...
    patience_limit = 10   # Stop training if no improvement for 10 epochs
    ...
    plt.plot(range(len(TRAIN_LOSS)), TRAIN_LOSS, color="blue", label="Training Set")
    plt.plot(range(len(VALIDATION_LOSS)), VALIDATION_LOSS, color='red', label="Validation Set")
    plt.legend()
